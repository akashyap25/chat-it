                    ...
                    <form onSubmit={handleSubmit} className='mt-6'>
                        <div className='flex items-center my-4 bg-gray-900 py-1 rounded-md'>
                            ...
                            <input
                                ...
                                className='w-11/12 py-2 px-1 bg-gray-900'
                                type='text'
                        ...
                        <div className='w-full flex items-center justify-center'>
                            <button
                                disabled={loading}
                                className={`${loading ? 'cursor-default' : 'active:scale-75'} bg-login text-gray-600 px-4 py-2 rounded-lg font-bold flex items-center justify-center drop-shadow-2xl duration-300`}
                            >
