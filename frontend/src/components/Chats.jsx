...
const Chats = ({ friend }) => {
    ...
    const { setChat, chatDiv, showChat } = useContext(ChatController);
    const { setMessages, messages, setLoading } = useContext(MessageController);
    const { friends } = useContext(FriendController);
